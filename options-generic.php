...
<?php
  echo(
    ...
    '</label></p>'.
    '<p><label>'.
    sprintf(__('Do not display plugin attribution link.  I will %sdonate%s and/or write about this plugin.', $this->name), '<a href="http://omninoggin.com/donate">', '</a>').' &nbsp; <input name="snd_options[show_link]" value="off" type="radio" '.checked(false, $snd_options['show_link'], false).'/>'.
    '</label></p>'
  );
